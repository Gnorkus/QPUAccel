...
sub r0, 8, num_gpus     		# r0 = 8-num_gpus
...
sub   r1, r1, 1
#add   r1, r1, r3					    # add the index to the input read
...
mov vw_setup, vdw_setup_0(64, 14, dma_h32(0,1))
